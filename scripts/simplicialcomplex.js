...
function drawComplex(){
  ...
  function init() {
    ...
    container = document.getElementById('simplComplContainer');
    ...
    var lineMaterial = new THREE.LineBasicMaterial({ color: 0x005500, linewidth: 8 });
    ...
    var triMaterial = new THREE.MeshStandardMaterial( { color: 0xff0000 } );
